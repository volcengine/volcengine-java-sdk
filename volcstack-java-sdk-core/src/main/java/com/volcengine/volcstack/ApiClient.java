...
import com.volcengine.volcstack.sign.ServiceInfo;
import com.volcengine.volcstack.sign.VolcstackSign;
...
public class ApiClient {
    private final static String DefaultAuthentication = "volcstackSign";
    ...
    public ApiClient setRegion(String region) {
        ...
        if (authentication instanceof VolcstackSign) {
            ...
            volcstackSign.setRegion(region);
        }
        return this;
    }
    ...
    public ApiClient setCredentials(Credentials credentials) {
        ...
        if (authentication instanceof VolcstackSign) {
            VolcstackSign volcstackSign = (VolcstackSign) authentication;
            volcstackSign.setCredentials(credentials);
        }
        return this;
    }
