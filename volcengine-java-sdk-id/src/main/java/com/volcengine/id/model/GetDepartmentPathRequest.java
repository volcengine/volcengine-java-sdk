...
public class GetDepartmentPathRequest {
  ...
  public GetDepartmentPathRequest departmentUid(String departmentUid) {
 ...
 @Size(min=1,max=128)  @Schema(required = true, description = "")
  ...
  public GetDepartmentPathRequest userPoolUid(String userPoolUid) {
 ...
 @Size(min=1,max=128)  @Schema(required = true, description = "")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetDepartmentPathRequest getDepartmentPathRequest = (GetDepartmentPathRequest) o;
    return Objects.equals(this.departmentUid, getDepartmentPathRequest.departmentUid) &&
        Objects.equals(this.userPoolUid, getDepartmentPathRequest.userPoolUid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(departmentUid, userPoolUid);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDepartmentPathRequest {\n");
