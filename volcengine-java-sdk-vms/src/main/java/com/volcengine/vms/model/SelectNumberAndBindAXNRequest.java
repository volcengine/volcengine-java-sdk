...
public class SelectNumberAndBindAXNRequest {
  ...
  public SelectNumberAndBindAXNRequest audioRecordFlag(Integer audioRecordFlag) {
  ...
  **/
  ...
  public SelectNumberAndBindAXNRequest cityCode(String cityCode) {
  ...
  **/
  ...
  public SelectNumberAndBindAXNRequest cityCodeByPhoneNo(CityCodeByPhoneNoEnum cityCodeByPhoneNo) {
  ...
  **/
  ...
  public SelectNumberAndBindAXNRequest degradeCityList(List<String> degradeCityList) {
    this.degradeCityList = degradeCityList;
    return this;
  }

  public SelectNumberAndBindAXNRequest addDegradeCityListItem(String degradeCityListItem) {
  ...
  **/
  ...
  public SelectNumberAndBindAXNRequest expireTime(Long expireTime) {
  ...
  **/
  ...
  public SelectNumberAndBindAXNRequest numberPoolNo(String numberPoolNo) {
  ...
  **/
  ...
  public SelectNumberAndBindAXNRequest phoneNoA(String phoneNoA) {
  ...
  **/
  ...
  public SelectNumberAndBindAXNRequest phoneNoB(String phoneNoB) {
  ...
  **/
  ...
  public SelectNumberAndBindAXNRequest randomFlag(Integer randomFlag) {
  ...
  **/
  ...
  public SelectNumberAndBindAXNRequest userData(String userData) {
 ...
 @Size(max=2048)  @Schema(description = "")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SelectNumberAndBindAXNRequest selectNumberAndBindAXNRequest = (SelectNumberAndBindAXNRequest) o;
    return Objects.equals(this.audioRecordFlag, selectNumberAndBindAXNRequest.audioRecordFlag) &&
        Objects.equals(this.cityCode, selectNumberAndBindAXNRequest.cityCode) &&
        Objects.equals(this.cityCodeByPhoneNo, selectNumberAndBindAXNRequest.cityCodeByPhoneNo) &&
        Objects.equals(this.degradeCityList, selectNumberAndBindAXNRequest.degradeCityList) &&
        Objects.equals(this.expireTime, selectNumberAndBindAXNRequest.expireTime) &&
        Objects.equals(this.numberPoolNo, selectNumberAndBindAXNRequest.numberPoolNo) &&
        Objects.equals(this.phoneNoA, selectNumberAndBindAXNRequest.phoneNoA) &&
        Objects.equals(this.phoneNoB, selectNumberAndBindAXNRequest.phoneNoB) &&
        Objects.equals(this.randomFlag, selectNumberAndBindAXNRequest.randomFlag) &&
        Objects.equals(this.userData, selectNumberAndBindAXNRequest.userData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(audioRecordFlag, cityCode, cityCodeByPhoneNo, degradeCityList, expireTime, numberPoolNo, phoneNoA, phoneNoB, randomFlag, userData);
  }
  ...
  public String toString() {
    ...
    sb.append("class SelectNumberAndBindAXNRequest {\n");
