...
public class TestDeleteListener {
    public static void main(String[] args) throws Exception {
        ...
        deleteListenerRequest.setListenerId("lsn-2fek3rgsxhrsw5oxruwec****");
        
        try {
            DeleteListenerResponse response = api.deleteListener(deleteListenerRequest);
