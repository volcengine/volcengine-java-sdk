...
public class TestDeleteScalingPolicy {
    public static void main(String[] args) throws Exception {
        ...
        deleteScalingPolicyRequest.setScalingPolicyId("sp-ybmvamf8uql8j1fl****");
        
        try {
            DeleteScalingPolicyResponse response = api.deleteScalingPolicy(deleteScalingPolicyRequest);
