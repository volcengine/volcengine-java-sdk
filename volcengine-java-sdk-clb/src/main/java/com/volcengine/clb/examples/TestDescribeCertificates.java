...
public class TestDescribeCertificates {
    public static void main(String[] args) throws Exception {
        ...
        describeCertificatesRequest.setCertificateIds(Arrays.asList("cert-3tjuxoukkq3vj0ww****"));
        
        try {
            DescribeCertificatesResponse response = api.describeCertificates(describeCertificatesRequest);
