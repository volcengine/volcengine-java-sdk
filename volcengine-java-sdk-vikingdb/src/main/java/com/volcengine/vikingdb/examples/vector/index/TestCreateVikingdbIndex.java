...
public class TestCreateVikingdbIndex {
    public static void main(String[] args) {
        ...
        CreateVikingdbIndexRequest request = new CreateVikingdbIndexRequest()
                ...
                .indexName("idx_1")
                .shardPolicy(CreateVikingdbIndexRequest.ShardPolicyEnum.AUTO)
                ...
                .scalarIndex(Arrays.asList("f_int64_1", "f_string_1", "f_list_string_1", "f_float_1"));
