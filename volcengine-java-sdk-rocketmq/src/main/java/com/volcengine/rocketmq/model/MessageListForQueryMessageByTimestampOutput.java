...
public class MessageListForQueryMessageByTimestampOutput {
  ...
  public MessageListForQueryMessageByTimestampOutput body(String body) {
    this.body = body;
    return this;
  }
  ...
  **/
  ...
  public MessageListForQueryMessageByTimestampOutput createTimestamp(Long createTimestamp) {
  ...
  **/
  ...
  public MessageListForQueryMessageByTimestampOutput isExist(Boolean isExist) {
  ...
  **/
  ...
  public MessageListForQueryMessageByTimestampOutput messageId(String messageId) {
  ...
  **/
  ...
  public MessageListForQueryMessageByTimestampOutput messageKey(String messageKey) {
  ...
  **/
  ...
  public MessageListForQueryMessageByTimestampOutput producerHost(String producerHost) {
  ...
  **/
  ...
  public MessageListForQueryMessageByTimestampOutput storeTimestamp(Long storeTimestamp) {
  ...
  **/
  ...
  public MessageListForQueryMessageByTimestampOutput tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.body, messageListForQueryMessageByTimestampOutput.body) &&
        Objects.equals(this.createTimestamp, messageListForQueryMessageByTimestampOutput.createTimestamp) &&
        Objects.equals(this.isExist, messageListForQueryMessageByTimestampOutput.isExist) &&
        Objects.equals(this.messageId, messageListForQueryMessageByTimestampOutput.messageId) &&
        Objects.equals(this.messageKey, messageListForQueryMessageByTimestampOutput.messageKey) &&
        Objects.equals(this.messageSize, messageListForQueryMessageByTimestampOutput.messageSize) &&
        Objects.equals(this.producerHost, messageListForQueryMessageByTimestampOutput.producerHost) &&
        Objects.equals(this.storeTimestamp, messageListForQueryMessageByTimestampOutput.storeTimestamp) &&
        Objects.equals(this.tag, messageListForQueryMessageByTimestampOutput.tag) &&
