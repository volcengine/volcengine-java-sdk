...
import com.volcengine.vefaasdev.model.EnvForGetFunctionOutput;
import com.volcengine.vefaasdev.model.NasStorageForGetFunctionOutput;
import com.volcengine.vefaasdev.model.TlsConfigForGetFunctionOutput;
import com.volcengine.vefaasdev.model.TosMountConfigForGetFunctionOutput;
import com.volcengine.vefaasdev.model.VpcConfigForGetFunctionOutput;
...
public class GetFunctionResponse extends com.volcengine.model.AbstractResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(codeSize, codeSizeLimit, command, cpuStrategy, creationTime, description, envs, exclusiveMode, id, initializerSec, instanceType, lastUpdateTime, maxConcurrency, memoryMB, name, nasStorage, owner, port, projectName, requestTimeout, runtime, source, sourceLocation, sourceType, tlsConfig, tosMountConfig, triggersCount, vpcConfig);
  }
