...
import com.volcengine.mockprovider20250101.model.CreateRulesARequest;
import com.volcengine.mockprovider20250101.model.CreateRulesAResponse;
import com.volcengine.mockprovider20250101.model.CreateRulesRequest;
import com.volcengine.mockprovider20250101.model.CreateRulesResponse;
import com.volcengine.mockprovider20250101.model.DescribeRulesRequest;
import com.volcengine.mockprovider20250101.model.DescribeRulesResponse;
...
public class MockProvider20250101Api {
    ...
    public com.squareup.okhttp.Call createRulesCall(CreateRulesRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/CreateRules/2025-01-01/mock_provider/get/text_plain/";
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createRulesACall(CreateRulesARequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/CreateRulesA/2025-01-01/mock_provider/post/application_x-www-form-urlencoded/";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createRulesAValidateBeforeCall(CreateRulesARequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling createRulesA(Async)");
        }
        
        com.squareup.okhttp.Call call = createRulesACall(body, progressListener, progressRequestListener);
        return call;
     ...
     * 
     * @param body  (required)
     * @return CreateRulesAResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CreateRulesAResponse createRulesA(CreateRulesARequest body) throws ApiException {
        ApiResponse<CreateRulesAResponse> resp = createRulesAWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * 
     * @param body  (required)
     * @return ApiResponse&lt;CreateRulesAResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CreateRulesAResponse> createRulesAWithHttpInfo( @NotNull CreateRulesARequest body) throws ApiException {
        com.squareup.okhttp.Call call = createRulesAValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<CreateRulesAResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createRulesAAsync(CreateRulesARequest body, final ApiCallback<CreateRulesAResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createRulesAValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CreateRulesAResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public com.squareup.okhttp.Call describeRulesCall(DescribeRulesRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/DescribeRules/2025-01-01/mock_provider/get/text_plain/";
