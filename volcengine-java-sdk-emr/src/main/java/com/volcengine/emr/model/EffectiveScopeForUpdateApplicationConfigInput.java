...
/**
 * EffectiveScopeForUpdateApplicationConfigInput
 */



public class EffectiveScopeForUpdateApplicationConfigInput {
  ...
  public EffectiveScopeForUpdateApplicationConfigInput componentNames(List<String> componentNames) {
    this.componentNames = componentNames;
    return this;
  }

  public EffectiveScopeForUpdateApplicationConfigInput addComponentNamesItem(String componentNamesItem) {
  ...
  **/
  ...
  public EffectiveScopeForUpdateApplicationConfigInput effectiveType(EffectiveTypeEnum effectiveType) {
  ...
  **/
  ...
  public EffectiveScopeForUpdateApplicationConfigInput nodeGroupIds(List<String> nodeGroupIds) {
    this.nodeGroupIds = nodeGroupIds;
    return this;
  }

  public EffectiveScopeForUpdateApplicationConfigInput addNodeGroupIdsItem(String nodeGroupIdsItem) {
  ...
  **/
  ...
  public EffectiveScopeForUpdateApplicationConfigInput nodeGroupNames(List<String> nodeGroupNames) {
    this.nodeGroupNames = nodeGroupNames;
    return this;
  }

  public EffectiveScopeForUpdateApplicationConfigInput addNodeGroupNamesItem(String nodeGroupNamesItem) {
  ...
  **/
  ...
  public EffectiveScopeForUpdateApplicationConfigInput nodeGroupTypes(List<String> nodeGroupTypes) {
    this.nodeGroupTypes = nodeGroupTypes;
    return this;
  }

  public EffectiveScopeForUpdateApplicationConfigInput addNodeGroupTypesItem(String nodeGroupTypesItem) {
  ...
  **/
  ...
  public EffectiveScopeForUpdateApplicationConfigInput nodeIds(List<String> nodeIds) {
    this.nodeIds = nodeIds;
    return this;
  }

  public EffectiveScopeForUpdateApplicationConfigInput addNodeIdsItem(String nodeIdsItem) {
  ...
  **/
  ...
  public EffectiveScopeForUpdateApplicationConfigInput nodeNames(List<String> nodeNames) {
    this.nodeNames = nodeNames;
    return this;
  }

  public EffectiveScopeForUpdateApplicationConfigInput addNodeNamesItem(String nodeNamesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EffectiveScopeForUpdateApplicationConfigInput effectiveScopeForUpdateApplicationConfigInput = (EffectiveScopeForUpdateApplicationConfigInput) o;
    return Objects.equals(this.componentNames, effectiveScopeForUpdateApplicationConfigInput.componentNames) &&
        Objects.equals(this.effectiveType, effectiveScopeForUpdateApplicationConfigInput.effectiveType) &&
        Objects.equals(this.nodeGroupIds, effectiveScopeForUpdateApplicationConfigInput.nodeGroupIds) &&
        Objects.equals(this.nodeGroupNames, effectiveScopeForUpdateApplicationConfigInput.nodeGroupNames) &&
        Objects.equals(this.nodeGroupTypes, effectiveScopeForUpdateApplicationConfigInput.nodeGroupTypes) &&
        Objects.equals(this.nodeIds, effectiveScopeForUpdateApplicationConfigInput.nodeIds) &&
        Objects.equals(this.nodeNames, effectiveScopeForUpdateApplicationConfigInput.nodeNames);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectiveScopeForUpdateApplicationConfigInput {\n");
