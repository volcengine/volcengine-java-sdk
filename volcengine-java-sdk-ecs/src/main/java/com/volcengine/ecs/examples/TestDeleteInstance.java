...
public class TestDeleteInstance {
    public static void main(String[] args) throws Exception {
        ...
        deleteInstanceRequest.setInstanceId("i-3thhlu8byl4bwb******");
        
        try {
            DeleteInstanceResponse response = api.deleteInstance(deleteInstanceRequest);
