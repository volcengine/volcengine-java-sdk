...
public class TestListVikingdbCollection {
    public static void main(String[] args) {
        ...
        ListVikingdbCollectionRequest request = new ListVikingdbCollectionRequest()
                .filter(new FilterForListVikingdbCollectionInput().collectionNameKeyword("test"));
        ...
        try {
            ...
            System.out.println("response getCollections: " + response.getCollections());
