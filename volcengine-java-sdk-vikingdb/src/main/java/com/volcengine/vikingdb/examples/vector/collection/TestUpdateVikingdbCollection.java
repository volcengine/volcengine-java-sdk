...
public class TestUpdateVikingdbCollection {
    public static void main(String[] args) {
        ...
        UpdateVikingdbCollectionRequest request = new UpdateVikingdbCollectionRequest()
                ...
                .fields(Arrays.asList(
                        new FieldForUpdateVikingdbCollectionInput().fieldName("f_string_2").fieldType(FieldForUpdateVikingdbCollectionInput.FieldTypeEnum.STRING),
                        new FieldForUpdateVikingdbCollectionInput().fieldName("f_int64_2").fieldType(FieldForUpdateVikingdbCollectionInput.FieldTypeEnum.INT64)
                ));
