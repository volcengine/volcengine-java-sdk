...
public class TestDeleteScalingGroup {
    public static void main(String[] args) throws Exception {
        ...
        deleteScalingGroupRequest.setScalingGroupId("scg-ybmssdnnhn5pkgyd****");
        
        try {
            DeleteScalingGroupResponse response = api.deleteScalingGroup(deleteScalingGroupRequest);
