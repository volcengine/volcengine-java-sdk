...
public class TestRebootInstance {
    public static void main(String[] args) throws Exception {
        ...
        rebootInstanceRequest.setInstanceId("i-3tiefmkskq3vj0******");
        
        try {
            RebootInstanceResponse response = api.rebootInstance(rebootInstanceRequest);
