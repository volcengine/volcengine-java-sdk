...
public class TestAssociateNetworkAcl {
    public static void main(String[] args) throws Exception {
        ...
        ResourceForAssociateNetworkAclInput reqResource = new ResourceForAssociateNetworkAclInput();
        ...
        associateNetworkAclRequest.setResource(Arrays.asList(reqResource, reqResource1));
