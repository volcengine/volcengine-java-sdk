...
import com.volcengine.volcstack.vpc.model.AssociatedElasticIpForDescribeNetworkInterfaceAttributesOutput;
...
public class DescribeNetworkInterfaceAttributesResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, associatedElasticIp, createdAt, description, deviceId, macAddress, networkInterfaceId, networkInterfaceName, portSecurityEnabled, primaryIpAddress, requestId, securityGroupIds, status, subnetId, type, updatedAt, vpcId, vpcName, zoneId);
  }
