...
public class TestDetachInstances {
    public static void main(String[] args) throws Exception {
        ...
        detachInstancesRequest.setInstanceIds(Arrays.asList("i-ybmike5l70l8j1ha****"));
        detachInstancesRequest.setScalingGroupId("scg-ybmssdnnhn5pkgyd****");
        
        try {
            DetachInstancesResponse response = api.detachInstances(detachInstancesRequest);
