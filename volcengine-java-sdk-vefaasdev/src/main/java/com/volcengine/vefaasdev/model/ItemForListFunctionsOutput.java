...
import com.volcengine.vefaasdev.model.EnvForListFunctionsOutput;
import com.volcengine.vefaasdev.model.NasStorageForListFunctionsOutput;
import com.volcengine.vefaasdev.model.TagForListFunctionsOutput;
import com.volcengine.vefaasdev.model.TlsConfigForListFunctionsOutput;
import com.volcengine.vefaasdev.model.TosMountConfigForListFunctionsOutput;
import com.volcengine.vefaasdev.model.VpcConfigForListFunctionsOutput;
...
public class ItemForListFunctionsOutput {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(codeSize, codeSizeLimit, command, cpuStrategy, creationTime, description, envs, exclusiveMode, id, initializerSec, instanceType, lastUpdateTime, maxConcurrency, memoryMB, name, nasStorage, owner, port, projectName, requestTimeout, runtime, source, sourceLocation, sourceType, tags, tlsConfig, tosMountConfig, triggersCount, vpcConfig);
  }
