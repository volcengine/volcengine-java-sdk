...
public class RestoreToCrossRegionInstanceRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowListIds, backupId, chargeInfo, dbParamGroupId, dstRegionId, instanceName, instanceTags, nodeInfo, projectName, restoreTime, srcRegionId, srcRegionInstanceId, storageSpace, storageType, subnetId, vpcId);
  }
