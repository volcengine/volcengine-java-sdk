...
public class VpcForDescribeVpcsOutput {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, associateCens, cidrBlock, creationTime, description, dnsServers, natGatewayIds, routeTableIds, securityGroupIds, status, subnetIds, updateTime, vpcId, vpcName);
  }
