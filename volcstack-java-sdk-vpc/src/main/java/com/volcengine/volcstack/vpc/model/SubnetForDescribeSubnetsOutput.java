...
import com.volcengine.volcstack.vpc.model.RouteTableForDescribeSubnetsOutput;
...
public class SubnetForDescribeSubnetsOutput {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, availableIpAddressCount, cidrBlock, creationTime, description, routeTable, status, subnetId, subnetName, totalIpv4Count, updateTime, vpcId, zoneId);
  }
