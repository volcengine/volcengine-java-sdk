...
public class GetDepartmentRequest {
  ...
  public GetDepartmentRequest departmentUid(String departmentUid) {
 ...
 @Size(min=1,max=128)  @Schema(required = true, description = "")
  ...
  public GetDepartmentRequest userPoolUid(String userPoolUid) {
 ...
 @Size(min=1,max=128)  @Schema(required = true, description = "")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.departmentUid, getDepartmentRequest.departmentUid) &&
        Objects.equals(this.userPoolUid, getDepartmentRequest.userPoolUid);
  }
