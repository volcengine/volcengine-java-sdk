...
import com.volcengine.fwcenter.model.DataForDescribeVpcsOutput;
...
public class DescribeVpcsResponse extends com.volcengine.model.AbstractResponse {
  ...
  public DescribeVpcsResponse addDataItem(DataForDescribeVpcsOutput dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<DataForDescribeVpcsOutput>();
    }
  ...
  **/
  @Valid
  @Schema(description = "")
  public List<DataForDescribeVpcsOutput> getData() {
    return data;
  }

  public void setData(List<DataForDescribeVpcsOutput> data) {
    this.data = data;
  }
