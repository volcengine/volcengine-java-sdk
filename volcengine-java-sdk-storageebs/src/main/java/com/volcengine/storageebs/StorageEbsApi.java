...
import com.volcengine.storageebs.model.CalculatePriceV2Request;
import com.volcengine.storageebs.model.CalculatePriceV2Response;
...
import com.volcengine.storageebs.model.CreatePlacementGroupRequest;
import com.volcengine.storageebs.model.CreatePlacementGroupResponse;
...
import com.volcengine.storageebs.model.DeletePlacementGroupRequest;
import com.volcengine.storageebs.model.DeletePlacementGroupResponse;
...
import com.volcengine.storageebs.model.DescribePlacementGroupDetailsRequest;
import com.volcengine.storageebs.model.DescribePlacementGroupDetailsResponse;
import com.volcengine.storageebs.model.DescribePlacementGroupsRequest;
import com.volcengine.storageebs.model.DescribePlacementGroupsResponse;
...
import com.volcengine.storageebs.model.ModifyPlacementGroupRequest;
import com.volcengine.storageebs.model.ModifyPlacementGroupResponse;
...
import com.volcengine.storageebs.model.ReInitializeVolumeRequest;
import com.volcengine.storageebs.model.ReInitializeVolumeResponse;
...
public class StorageEbsApi {
    ...
    /**
     * Build call for reInitializeVolume
     * @param body  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call reInitializeVolumeCall(ReInitializeVolumeRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/ReInitializeVolume/2020-04-01/storage_ebs/post/application_json/";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call reInitializeVolumeValidateBeforeCall(ReInitializeVolumeRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling reInitializeVolume(Async)");
        }
        
        com.squareup.okhttp.Call call = reInitializeVolumeCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ReInitializeVolumeResponse reInitializeVolume(ReInitializeVolumeRequest body) throws ApiException {
        ApiResponse<ReInitializeVolumeResponse> resp = reInitializeVolumeWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * 
     * @param body  (required)
     * @return ApiResponse&lt;ReInitializeVolumeResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ReInitializeVolumeResponse> reInitializeVolumeWithHttpInfo( @NotNull ReInitializeVolumeRequest body) throws ApiException {
        com.squareup.okhttp.Call call = reInitializeVolumeValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<ReInitializeVolumeResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call reInitializeVolumeAsync(ReInitializeVolumeRequest body, final ApiCallback<ReInitializeVolumeResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = reInitializeVolumeValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ReInitializeVolumeResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
