...
public class BasicInfoForDescribeDBInstanceDetailOutput {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backupUse, createTime, dbEngineVersion, dataSyncMode, instanceId, instanceName, instanceStatus, lowerCaseTableNames, maintenanceWindow, memory, nodeNumber, nodeSpec, projectName, regionId, storageSpace, storageType, storageUse, subnetId, tags, timeZone, updateTime, VCPU, vpcId, zoneId);
  }
